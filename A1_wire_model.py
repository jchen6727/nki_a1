...
### Regular Spiking (RS)
netParams.popParams['E2'] = {'cellType': 'RS', 'numCells': , 'cellModel': ''}
netParams.popParams['E4'] = {'cellType': 'RS', 'numCells': , 'cellModel': ''}
netParams.popParams['E5R'] = {'cellType': 'RS', 'numCells': , 'cellModel': ''}
netParams.popParams['E6'] = {'cellType': 'RS', 'numCells': , 'cellModel': ''}
### Fast Spiking (FS)
netParams.popParams['I2'] = {'cellType': 'FS', 'numCells': , 'cellModel': ''}
netParams.popParams['I4'] = {'cellType': 'FS', 'numCells': , 'cellModel': ''}
netParams.popParams['I5'] = {'cellType': 'FS', 'numCells': , 'cellModel': ''}
netParams.popParams['I6'] = {'cellType': 'FS', 'numCells': , 'cellModel': ''}
### Low Threshold Spiking (LTS)
netParams.popParams['I2L'] = {'cellType': 'LTS', 'numCells': , 'cellModel': ''}
netParams.popParams['I4L'] = {'cellType': 'LTS', 'numCells': , 'cellModel': ''}
netParams.popParams['I5L'] = {'cellType': 'LTS', 'numCells': , 'cellModel': ''}
netParams.popParams['I6L'] = {'cellType': 'LTS', 'numCells': , 'cellModel': ''}
### Burst Firing (Burst)
netParams.popParams['E5B'] = {'cellType': 'Burst', 'numCells': , 'cellModel': ''}
### THALAMUS (core)
netParams.popParams['TC'] = {'cellType': 'thal_core', 'numCells': , 'cellModel': ''}
netParams.popParams['HTC'] = {'cellType': 'thal_core', 'numCells': , 'cellModel': ''}
netParams.popParams['IRE'] = {'cellType': 'thal_core', 'numCells': , 'cellModel': ''}
### THALAMUS (matrix)
netParams.popParams['TCM'] = {'cellType': 'thal_matrix', 'numCells': , 'cellModel': ''}
netParams.popParams['IREM'] = {'cellType': 'thal_matrix', 'numCells': , 'cellModel': ''}
#### CELL TYPES LISTED ABOVE COME FROM labels.py -- NOT OFFICIAL YET! 2/15/19
