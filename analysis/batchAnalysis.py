...
if __name__ == '__main__': 
    dataFolder = '../data/'
    batchLabel = 'v25_batch12'  # 'v50_batch1' #
    ...
    df = popRateAnalysis(dataFolder, batchLabel, loadAll, pars=['weightBkgE', 'weightBkgI','rateBkg_exc', 'rateBkg_inh'], vals=['NGF2'], groupStat='first', plotLine=False) 
