...
if __name__ == '__main__': 
    dataFolder = '../data/'
    batchLabel = 'v25_batch13'  # 'v50_batch1' #
    ...
    df = popRateAnalysis(dataFolder, batchLabel, loadAll, pars=['weightBkgE', 'weightBkgI','rateBkg_exc', 'rateBkg_inh'], vals=['VIP2'], groupStat='first', plotLine=False) 
