...
if __name__ == '__main__':
  ...
  for dataFile in dataFiles: # or dataFiles_test if want specific files # dataFiles[2:3] --> '2-um040041020@os_eye06_30.mat'
    ...
    plotLFP(dat=LFP_data,tt=tt,timeRange=[1900,6900],plots=['timeSeries'],electrodes=[6,12,19],trigtimes=trigtimes,saveFig=True, fn=fullPath) # fn=fullPath,dbpath = dbpath,  # 16,19 #[4,12]
