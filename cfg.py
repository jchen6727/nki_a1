...
cfg.analysis['plotTraces'] = {'include': [0,100, 1285, 1787,2422, 2464, 2470,30,97,98], 'overlay': True, 'saveFig': True, 'showFig': False} #[(pop,0) for pop in alltypes]		## Seen in M1 cfg.py (line 68) 
