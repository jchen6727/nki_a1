...
def custom():
    ...
    return b
** v34_batch23 - tuning; v34_batch15_trial_5955; optuna with 16 L2 cell-type-specific weight params (targeting PV2, SOM2, VIP2) - deleted by accident!
*** code
    # from prev
    import json
    with open('data/v34_batch15/trial_5955/trial_5955_cfg.json', 'rb') as f:
...
** v34_batch24 - tuning; v34_batch15_trial_5955; optuna with 16 L2,3 cell-type-specific weight params (targeting PV2, SOM2, VIP2, SOM3)
** blank
