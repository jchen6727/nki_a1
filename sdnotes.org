...
** v32_batch13 - from v32_batch11, scale 1.0, only thal+L2+L3+L4, param range 0.1 - 4.0
** v32_batch14 - from v32_batch13, scale 1.0, only thal+L2+L3+L4, param range narrower
