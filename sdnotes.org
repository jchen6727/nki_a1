...
** v34_batch8 - tuning; L2-5A; best of v34_batch4; optuna with large range L5A, small range rest
*** notes
...
** v34_batch9 - tuning; L2-5B; best of v34_batch8; optuna with large range L5B, small range rest
*** notes
    # from prev
    import json
...
** v34_batch10 - v34_batch9 increased IE range to 0.1-4
*** notes
*** results
- fitness ~199 after 10k sims
- SOM2, SOM3, PT5B silent

** v34_batch11 -  tuning; L2-5B; best of v34_batch10; optuna with L2, L3, L5B, EI +-0.25; rest +0.1
*** code
...
** v34_batch12 - tuning; L2-5B; best of v34_batch10; optuna with L2, L3, L5B, EI +-0.25; rest +0.1; E-SOM, SOM-E, and L5B increased range to +-1.0
*** code
...
** v34_batch13 - tuning; L2-5B; best of v34_batch11; optuna with IE, L5B 0.1-4.0; L2, L3, EI +-0.25; rest +-0.1; similar to v32_batch1 (L2-L5B 50% density)
*** code
    # from prev
    import json
...
** v34_batch14 - tuning; L1-6; best of v34_batch11; optuna with L1,L6 +-0.15; IE,EI +-0.25; rest +-0.1; changed fitness func of I cells to be >0.05Hz (before >0.5)
*** code
** v34_batch15 - tuning; L1-6; best of v34_batch14; optuna with all params +-0.2
*** code
...
** v34_batch16 - tuning; L1-6; best of v34_batch15; optuna with all params +-0.2
*** code
...
** v34_batch17 - tuning; L1-6; best of v34_batch15; optuna with all params +-0.2; maxFitness=2000
*** code
    ...
    return b
** v34_batch18 - tuning; L1-6; best of v34_batch15; optuna with all params +- 25%; maxFitness=2000; maxV=0.5
*** code
   rangeV1 = 0.2
    rangeV2 = 0.25
    rangeV3 = 2.0
