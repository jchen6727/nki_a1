...
-- https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3198376/
* Feb62020 Carney model for Auditory nerve fibers (ANF) and Inferior Colliculus (IC)
** email from slava
Hi Everyone,
...
* Feb182020 Preparing to tune model
...
** v16_batch1 Small parameter on full net 300x300 um (29k cells); to get baseline
*** code
def custom():
    params = specs.ODict()
...
memory error
*** running 200um (12k cells) on 4*96 cores
