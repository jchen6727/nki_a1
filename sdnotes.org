...
Total time = 785.50 s
* 11Oct2019 Preparing SfN poster
...
- https://www.dropbox.com/sh/xb7xasih3d8027u/AABw_eBXymSYJfgSiH-E6th0a/create_recurrent_connections?dl=0&preview=connect_cells.py&subfolder_nav_tracking=1
...
def EIbalance():
    ...
    params[('weightBkg', 'E')] = [0.5, 1.0, 1.5]
    params[('weightBkg', 'I')] = [0.5, 1.0, 1.5]
