...
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
** v30_batch5 - tune L2+3+4 + thal
*** notes
increased duration since requires 1.5 sec to reach steady state
- needs over 1.5 sec to reach steady state!!!
- ITS4 not firing
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
** v30_batch6 - tune only L3+L4+thal; include L4 weights but starting from tuned and smaller interval - bug
*** notes
fitness func didn't include L3 pops
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
** v30_batch7 - same as v30_batch6 but fixed fitness func to include L3 pops
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
** v30_batch8 - added L2 and reduced width of gaussian tuning window
*** note
results were getting very low fitness, so made tuning func more restrictive by narrowing the gaussian func widths
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
** v30_batch9 - best soln of v30_batch8, with param ranges +- 0.25, min rate = 0.5; increase min rate required
*** notes
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
*** code
...
** v30_batch10 - best soln of v30_batch8, with cell-type specific EI gains
*** notes
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
*** code
...
** v30_batch11 - L2+3+4+thal, layerwise + celltype
*** notes
https://docs.google.com/document/d/1Gbest9Xillhkq9XQ-UVBvq3AWZAkBBdcuDV74S7Nbtg/edit?usp=sharing
...
** v30_batch12 - L4 + thal,  layer-specific + celltype-specific gains
*** notes
...
** v30_batch13 - L4 + thal,  layer-specific + celltype-specific gains -- repeat
*** notes
very similar results -- good, as expected
** v31_batch2 - L4 + thal, layer-specific + celltype-specific gains; new ITS4
*** notes
...
** v31_batch3 - L2+L3+L4 layer- + celltype-specific gains
*** notes
fixed/frozen gains for thal from prev solution
...
** v31_batch4 - L2+L3+L4 layer- + celltype-specific gains -- try wider range for prev params
*** notes
same as v31_batch3 but E-PV, E-SOM, E-NGF, E-VIP params in range [prev-0.5:prev+0.5]
** v31_batch5 - L2+L3+L4 layer- + celltype-specific gains -- try wider range + min rate of 1 Hz
*** notes
same as v31_batch4 but min population rate set to 1.0 Hz (instead of 0.5 Hz)
** v31_batch6 - L2+L3+L4+L5A layer + celltype-specific gains; from v31_batch4; small ranges
*** notes
fixed/frozen gains for thal from prev solution
...
** v31_batch7 - L2+L3+L4+L5A+L5B layer + celltype-specific gains; from v31_batch6; small ranges (subset of params)
*** notes
fixed/frozen gains for thal from prev solution
...
20 params; 12 very small range, 4 small range, 4 large range
** v31_batch8 - L2+L3+L4+L5A+L5B layer + celltype-specific gains; from v31_batch6; small ranges (all params)
*** notes
fixed/frozen gains for thal from prev solution
...
** v31_batch9 - increase L5B range from 0.2-3.0 to 0.1-5.0; increase L2+L3 range from 0.1 to 0.25
*** notes
fixed/frozen gains for thal from prev solution
...
** v32_batch1 - L2-L5B; added IE presyn-cell-type specific params
*** notes
fixed/frozen gains for thal from prev solution
layer-specific EE,EI,IE,II gains for L2, with [prev-0.25:prev+0.25]
layer-specific EE,EI,IE,II gains for L3, with [prev-0.25:prev+025]
...
TI         2.720000
TIM        4.720000
** v32_batch2 - L2-L6; EI and IE cell-type specific gains; params from v32_batch1; 20 very small rannges
*** notes
fixed/frozen gains for thal from prev solution
layer-specific EE,EI,IE,II gains for L2, with [prev-0.1:prev+0.1]
layer-specific EE,EI,IE,II gains for L3, with [prev-0.1:prev+0.1]
...
** v32_batch3 - L1-L6; EI and IE cell-type specific gains; params from v32_batch1; added NGF1; inc range 0.1 to 0.15
*** notes
fixed/frozen gains for thal from prev solution
...
** v32_batch4 - best soln v32_batch3, +- 0.2 all params; min rate >=0.5Hz
*** notes
fixed/frozen gains for thal from prev solution
...
** v32_batch5 - best of v32_batch4, with LFP; 3 scales 
*** notes
*** code
def custom():
    params = specs.ODict()
    ...
    return b
** v32_batch6 - best of v32_batch4, with LFP; with cochlear/IC speech input; with different cortichothal gains
** v32_batch7 - best of v32_batch4, with LFP; scaled to 100% with different gains / scaling factors
** v32_batch8 - scale 1.0, from v32_batch4, with param range -0.4 +0.1
*** results
...
** v32_batch9 - scale 1.0, from v32_batch4, with param range -0.75 +0.25
** v32_batch10 - scale 1.0, from v32_batch4, with param range -1.0 +1.0
*** results
**** params order of importance (optuna)
...
** v32_batch11 - scale 1.0, only thal+L4, param range 0.1 - 4.0 - CHECK!
** v32_batch12 - best of v32_batch4, with LFP; with cochlear/IC speech input at 2000ms; with different weights 
** v32_batch13 - from v32_batch11, scale 1.0, only thal+L2+L3+L4, L2+3 param range 0.1-4.0; L4 +-0.1; I->EI +-0.25
*** results
fitness ~90
ITP4, ITS4 ~ 0 Hz
** v32_batch14 - from v32_batch13, scale 1.0, only thal+L2+L3+L4, L2+3+4 +-0.25; I->EI +-0.25
*** results
fitness ~90
**** params order of importance (optuna)
...
** v32_batch15 - best of v32_batch4, with LFP; with cochlear/IC speech input at 2000ms; with different conn probs
** v32_batch16 - from v32_batch13, scale 1.0, only thal+L2+L3+L4, param range +-1.0
*** results
fitness ~90

** v32_batch17 - full - CHECK!

** v32_batch18 - best of v32_batch4, scaled to 100%; grid search of main params - RAN
*** notes
EE - [0.25, 0.5, 0.75, 1.0] - 16
EI, IE, II - [0.5, 1.0, 1.5] - 9
E-PV, E-SOM, E-NGF, E-VIP - [0.5, 1.0, 1.5] - 27
total = 16*9*27 = 3888
use thal from v32_batch11 or 13
*** results
...
** v32_batch19 - optuna based on best solutions of v32_batch18; plus added L2+L3-specific IE gains 
*** code
...
** v32_batchX - scale 1.0, only thal+L2+L3+L4, param range 0.1-4.0
