...
** v34_batch61 - 1 very long sim (30 sec) with LFPpops; v34_batch25 (trial_2142); with LFP recordStep=0.05 to avoid artifact - crashed
*** notes
...
** v34_batch63 - 1 very long sim (20 sec) with LFPpops; v34_batch25 (trial_2142); with LFP recordStep=0.05 to avoid artifact - crashed
** v34_batch64 - 1 very long sim (20 sec) withOUT LFPpops; v34_batch25 (trial_2142); with LFP recordStep=0.05 to avoid artifact 
** v34_batch64 - 1 long sim (10 sec) with LFPpops; v34_batch57 seed 3_4 (for wavelets)
*** code
   params[('seeds', 'conn')] = [3] #list(range(1)) #[4321+(17*i) for i in range(5)]
    params[('seeds', 'stim')] = [4] #list(range(1)) #[1234+(17*i) for i in range(5)]
...
** XXX - seed 0_2; long sim with LFPpops; v34_batch25 (trial_2142); with LFP recordStep=0.05 to avoid artifact
