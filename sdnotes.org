...
** v32_batch18 - tuning - best of v32_batch4, scaled to 100%; grid search of main params
*** notes
...
** v32_batch27 - grid search tune to exp; scale 1.0; 4.5-sec; trial 974 from v32_batch19; with LFP; with and w/o cochlear IC/speech input; diff thal->conn gains
*** notes
...
- no stim:
    params['thalamoCorticalGain'] = [1.5, 1.75, 2.0, 2.25]
- speech:
