...
** v29_batch1 - add EIGain by layer; reduce EEGain [0, 1.0] - bug in EI
*** notes
- bug in EIgains by layer -- single EIgain, not layer-specific
...
** v29_batch2 - v29_batch1 with increased maxiters and GCP n2 80-core nodes - bug in EI!
*** notes
- bug in EIgains by layer -- single EIgain, not layer-specific
*** results
**** 1 layer at a time
...
*** Possible next steps
- increase bkg input or conn to NGF1, TIM, ITS4 (lower)
...
** v29_batch3 - increase bkg to NGF1, TIM, reduce ITS4; fix layerwise EIgains
*** notes
- reduce bkg weight ITS4 from 40 to 10
- increase TIM from 1.5 to 2.0
- increase NGF1 from 1.0 (wasn't included in list!) to 2.5
- added bkg weights for L5B inh pops (were missing!)
** v29_batch4 - same but replace ITS4 celltype with IT; inc TIM+IREM
*** notes
increased TIM bkg from 2.0 to 3.0
increased IREM from 1 to 1.5 
=======
