...
look very different ... (thick lines are NHP, thing lines are model)
...
** setup opt in optunaERP function in batch.py
* 23nov2
** sm suggests thalL4E==0.5 to avoid dep blockade
** try sim with thalL4E==0.5

can shorten sim duration and start BBN at 3 s instead of 4
